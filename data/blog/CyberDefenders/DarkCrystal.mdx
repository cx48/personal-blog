...
This is a **medium** level **endpoint forensic** lab by [CyberDefenders](https://cyberdefenders.org/blueteam-ctf-challenges/darkcrystal/). You can complete your analysis using either **MemProcFS**/**Volatility 3** and **Eric Zimmerman** Tools. Start by reading the scenario in the above image and then proceed to capture flags.
