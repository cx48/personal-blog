...
- You'll be left with 2 results - **0xffffff** indicates kerberos authentication failure - **0x17** tells us the encryption type used here
...
```
index=goldenspray  "winlog.event_data.User"="SECURETECH\\jsmith" | table _time, winlog.event_data.TargetFilename
| sort by _time
| reverse
```
